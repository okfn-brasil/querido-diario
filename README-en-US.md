...
# Thanks
This project is maintained by Open Knowledge Brazil and made possible thanks to the technical communities, volunteers and financial donors, in addition to partner universities, companies supporters and funders.
...
Here is a complete list of all documentation available in the `docs/` folder:

- [Code of Conduct](docs/CODE_OF_CONDUCT.md) | [Code of Conduct (EN)](docs/CODE_OF_CONDUCT-en-US.md)
