    ...
    <div class="section">
      <div class="container">
        ...
        <div class="has-text-centered">
          ...
          <img src="~/assets/gem.png" alt="" title="" class="municipality-icon municipality-wip" v-for="y in 8" :key="y" />
        </div>
        ...
        <div class="has-text-centered">
          <img src="~/assets/gem.png" alt="" class="municipality-icon municipality-wip" v-for="y in 2" :key="y" />
          <img src="~/assets/gem.png" alt="" title="" class="municipality-icon" v-for="y in 8" :key="y" />
        </div>
