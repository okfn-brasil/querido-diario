...
class MgManhuacuSpider(BaseGazetteSpider):
    TERRITORY_ID = "3139409"
    name = "mg_manhuacu"
    allowed_domains = ["manhuacu.mg.gov.br"]
    start_urls = [
        "https://www.manhuacu.mg.gov.br/diario-eletronico/caderno/diario-oficial-eletronico/1"
    ]

    ITEMS_PER_PAGE = "100"
    BASE_URL = "https://www.manhuacu.mg.gov.br/"
    ...
    def parse_items(self, response):
        ...
        for row in rows:
            ...
            url = "https://www.manhuacu.mg.gov.br/abrir_arquivo.aspx?cdLocal=12&arquivo={}{}".format(
